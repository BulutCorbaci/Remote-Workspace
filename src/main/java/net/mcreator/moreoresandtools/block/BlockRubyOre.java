...
public class BlockRubyOre extends ElementsMoreOresAndToolsMod.ModElement {
	@GameRegistry.ObjectHolder("more_ores_and_tools:ruby_ore")
	public static final Block block = null;
	public BlockRubyOre(ElementsMoreOresAndToolsMod instance) {
		super(instance, 25);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("more_ores_and_tools:ruby_ore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			...
			setHardness(11.399999999999999F);
			setResistance(14.547785254123173F);
			setLightLevel(0F);
			setLightOpacity(255);
