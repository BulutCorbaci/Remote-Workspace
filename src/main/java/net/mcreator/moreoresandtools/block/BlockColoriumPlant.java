...
public class BlockColoriumPlant extends ElementsMoreOresAndToolsMod.ModElement {
	@GameRegistry.ObjectHolder("more_ores_and_tools:colorium_plant")
	public static final Block block = null;
	public BlockColoriumPlant(ElementsMoreOresAndToolsMod instance) {
		super(instance, 117);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("more_ores_and_tools:colorium_plant", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("colorium_plant");
			setRegistryName("colorium_plant");
		}
