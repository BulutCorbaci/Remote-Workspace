...
public class BlockLritzWoodSlab extends ElementsMoreOresAndToolsMod.ModElement {
	@GameRegistry.ObjectHolder("more_ores_and_tools:lritz_wood_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("more_ores_and_tools:lritz_wood_slab_double")
	public static final Block block_slab_double = null;
	public BlockLritzWoodSlab(ElementsMoreOresAndToolsMod instance) {
		super(instance, 149);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lritz_wood_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("lritz_wood_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("more_ores_and_tools:lritz_wood_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("lritz_wood_slab");
